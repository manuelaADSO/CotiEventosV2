<!-- HERO -->
<div class="pt-20">
    <section class="bg-gradient-to-r from-sky-400 via-sky-200 to-sky-300 py-24">
        <div class="max-w-5xl mx-auto text-center px-6">
            ...
            <div class="w-24 h-1 bg-sky-600 mx-auto mb-6 rounded-full"></div>
    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center my-20">
            ...
            <div class="flex justify-center">
                <div class="w-80 h-80 rounded-full overflow-hidden shadow-2xl border-8 border-sky-200">
        ...
        <div class="space-y-8">
            ...
            <a href="<?= BASE_URL ?>/vestidosgrados"
               class="flex items-center bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300 group border-l-8 border-pink-400">

                <div class="text-4xl bg-pink-400 text-pink-500 p-4 rounded-full mr-6 group-hover:scale-110 transition">
                    👗
                </div>
            ...
            <a href="<?= BASE_URL ?>/trajesgrados"
               class="flex items-center bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300 group border-l-8 border-blue-300">

                <div class="text-4xl bg-blue-300 text-blue-400 p-4 rounded-full mr-6 group-hover:scale-110 transition">
                    🤵
                </div>
