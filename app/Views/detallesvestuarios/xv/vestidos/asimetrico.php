...
<head>
  ...
  <title>Vestido Asimétrico XV</title>
      ...
      <div>
        <div class="w-full max-h-[500px] md:max-h-[600px] mx-auto overflow-hidden rounded-3xl">
          <img id="imagen-principal"
               src="/cotieventosV2/assets/img/eventos/xv/vestuarios/vestidos/vestido_asimetrico.webp"
               class="w-full h-full object-contain transition duration-700"
               alt="Vestido Asimétrico">
        </div>
      </div>
    ...
    <div class="swiper mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/vestidos/miniaturas/asimetrico/01_asimetrico.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/vestidos/miniaturas/asimetrico/02_asimetrico.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/vestidos/miniaturas/asimetrico/03_asimetrico.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/vestidos/miniaturas/asimetrico/04_asimetrico.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/vestidos/miniaturas/asimetrico/05_asimetrico.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/vestidos/miniaturas/asimetrico/06_asimetrico.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/vestidos/miniaturas/asimetrico/07_asimetrico.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/vestidos/miniaturas/asimetrico/08_asimetrico.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
      </div>
    </div>
