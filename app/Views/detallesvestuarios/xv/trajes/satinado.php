...
<title>Traje gris oscuro con detalles satinados XV</title>
    ...
    <div class="grid lg:grid-cols-2 gap-10">
      ...
      <div>
        <div class="w-full max-h-[500px] md:max-h-[600px] mx-auto overflow-hidden rounded-3xl">
          <img id="imagen-principal"
               src="/cotieventosV2/assets/img/eventos/xv/vestuarios/trajes/traje_satinado.webp"
               class="w-full h-full object-contain transition duration-700"
               alt="Traje gris oscuro con detalles satinados">
        </div>
      </div>
      ...
      <div>
        ...
        <h1 class="text-4xl md:text-5xl font-normal leading-tight mt-2">
          Traje gris oscuro con detalles satinados
        </h1>
    ...
    <div class="swiper mySwiper">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/trajes/miniaturas/satinado/01_satinado.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/trajes/miniaturas/satinado/02_satinado.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/trajes/miniaturas/satinado/03_satinado.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/trajes/miniaturas/satinado/04_satinado.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/trajes/miniaturas/satinado/05_satinado.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/trajes/miniaturas/satinado/06_satinado.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/trajes/miniaturas/satinado/07_satinado.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/xv/vestuarios/trajes/miniaturas/satinado/08_satinado.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
