...
<title>Príncipe Real - Cumpleaños</title>
...
src="/cotieventosV2/assets/img/eventos/cumple/vestuarios/nino/principe_real.webp"
...
Un conjunto inspirado en la realeza, con saco elegante o capa decorativa y detalles dorados. 
Este vestuario convierte al niño en el rey de la celebración, resaltando su protagonismo y 
haciendo que cada momento sea digno de un cuento de hadas.
</p>
...
<img src="/cotieventosV2/assets/img/eventos/cumple/vestuarios/nino/miniaturas/principe/01_principe.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/eventos/cumple/vestuarios/nino/miniaturas/principe/02_principe.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/eventos/cumple/vestuarios/nino/miniaturas/principe/03_principe.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/eventos/cumple/vestuarios/nino/miniaturas/principe/04_principe.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/eventos/cumple/vestuarios/nino/miniaturas/principe/05_principe.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/eventos/cumple/vestuarios/nino/miniaturas/principe/06_principe.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/eventos/cumple/vestuarios/nino/miniaturas/principe/07_principe.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/eventos/cumple/vestuarios/nino/miniaturas/principe/08_principe.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>
