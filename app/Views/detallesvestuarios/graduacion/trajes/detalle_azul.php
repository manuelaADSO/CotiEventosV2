...
<div class="max-w-7xl mx-auto px-6 py-12">
    ...
    <div class="grid lg:grid-cols-2 gap-10">
        ...
        <div>
            <img id="imagen-principal"
                 src="./assets/img/eventos/graduacion/vestuarios/trajes/traje_azul.webp"
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
        ...
        <img src="./assets/img/eventos/graduacion/vestuarios/trajes/miniaturas/azul/01_azul.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/trajes/miniaturas/azul/02_azul.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/trajes/miniaturas/azul/03_azul.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/trajes/miniaturas/azul/04_azul.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/trajes/miniaturas/azul/05_azul.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/trajes/miniaturas/azul/06_azul.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/trajes/miniaturas/azul/07_azul.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/trajes/miniaturas/azul/08_azul.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">
    </div>
