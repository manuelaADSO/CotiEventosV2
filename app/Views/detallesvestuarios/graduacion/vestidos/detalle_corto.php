...
<div class="max-w-7xl mx-auto px-6 py-12">
    ...
    <div class="grid lg:grid-cols-2 gap-10">
        ...
        <div>
            <img id="imagen-principal"
                 src="./assets/img/eventos/graduacion/vestuarios/vestidos/vestido_corto.webp"
                 alt="Vestido Corto"
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
        ...
        <img src="./assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/corto/01_corto.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/corto/02_corto.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/corto/03_corto.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/corto/04_corto.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/corto/05_corto.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/corto/06_corto.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/corto/07_corto.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">

        <img src="./assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/corto/08_corto.webp"
             class="rounded-3xl object-cover w-full h-[420px] cursor-pointer hover:scale-105 transition"
             onclick="cambiarImagen(this)">
    </div>
