...
<title>Vestido Largo - Graduación</title>
      ...
      <div>
        <div class="w-full max-h-[500px] md:max-h-[600px] mx-auto overflow-hidden rounded-3xl shadow-md">
          <img id="imagen-principal"
               src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/vestido_largo.webp"
    ...
    <div class="swiper mySwiper">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/largo/01_largo.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/largo/02_largo.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/largo/03_largo.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/largo/04_largo.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/largo/05_largo.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/largo/06_largo.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/largo/07_largo.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/largo/08_largo.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
