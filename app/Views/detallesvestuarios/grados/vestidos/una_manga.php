...
<title>Vestido Una Sola Manga - Graduación</title>
...
<main class="pt-32 pb-20">
  <div class="max-w-7xl mx-auto px-6">
    <div class="grid lg:grid-cols-2 gap-10">
      ...
      <!-- IMAGEN PRINCIPAL -->
      <div>
        <div class="w-full max-h-[500px] md:max-h-[600px] mx-auto overflow-hidden rounded-3xl shadow-md">
          <img id="imagen-principal"
               src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/vestido_manga.webp"
...
Graduación
        ...
        <h2 class="font-bold text-3xl my-4">$499.900</h2>
    ...
    <div class="swiper mySwiper">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/una_manga/01_una_manga.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/una_manga/02_una_manga.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/una_manga/03_una_manga.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/una_manga/04_una_manga.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/una_manga/05_una_manga.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/una_manga/06_una_manga.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/una_manga/07_una_manga.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
        <div class="swiper-slide">
          <img src="/cotieventosV2/assets/img/eventos/graduacion/vestuarios/vestidos/miniaturas/una_manga/08_una_manga.webp"
               class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
        </div>
