        ...
        <div class="producto" data-genero="femenino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                ...
                <div class="p-8 text-center">
                    ...
                    <a href="<?= BASE_URL ?>/detallesvestuarios/graduacion/vestidos/detallelargo" class="inline-block bg-pink-500 text-white px-6 py-3 rounded-xl hover:bg-pink-600 transition">
                        Ver más
                    </a>
                </div>
            </div>
