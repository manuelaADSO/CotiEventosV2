        ...
        <div class="md:flex md:gap-8">
            <div class="md:w-5/12 mb-6 md:mb-0">
                <img id="imagen-principal" 
                     src="./assets/img/banquete/torta/grado/inicio/02_torta.webp" 
            ...
            <div class="md:w-7/12 flex flex-col justify-between">
                ...
                <div>
                    <h1 class="text-4xl md:text-5xl font-normal mb-4">Torta de Graduación Blanca con Birrete y Detalles Negros</h1>
 ...
 <!-- MINIATURAS (8 COMPLETAS) -->
    <div class="mt-16">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-6">
            ...
            <img src="./assets/img/banquete/torta/grado/02_torta/01_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/02_torta/02_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/02_torta/03_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/02_torta/04_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/02_torta/05_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/02_torta/06_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/02_torta/07_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/02_torta/08_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">
        </div>
    </div>
