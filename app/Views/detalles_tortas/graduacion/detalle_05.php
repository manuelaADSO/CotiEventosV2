        ...
        <div class="md:flex md:gap-8">
            <div class="md:w-5/12 mb-6 md:mb-0">
                <img id="imagen-principal" 
                     src="./assets/img/banquete/torta/grado/inicio/05_torta.webp" 
            ...
            <div class="md:w-7/12 flex flex-col justify-between">
                ...
                <div>
                    <h1 class="text-4xl md:text-5xl font-normal mb-4">orta de Graduación Decorativa con Siluetas</h1>
                    <p class="text-gray-600 text-lg md:text-xl mb-4">
                       Torta en tonos beige y negro con birrete superior y detalles decorativos alusivos a la graduación. 
                       Ideal para un evento especial y memorable.
                    </p>
 ...
 <!-- MINIATURAS (8 COMPLETAS) -->
    <div class="mt-16">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-6">
            ...
            <img src="./assets/img/banquete/torta/grado/05_torta/01_persona.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/05_torta/02_persona.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/05_torta/03_persona.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/05_torta/04_persona.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/05_torta/05_persona.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/05_torta/06_persona.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/05_torta/07_persona.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/05_torta/08_persona.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">
        </div>
    </div>
