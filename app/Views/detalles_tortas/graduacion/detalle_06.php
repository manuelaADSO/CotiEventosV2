    ...
    <div class="container mx-auto py-8 px-4">
        ...
        <div class="md:flex md:gap-8">
            ...
            <div class="md:w-7/12 flex flex-col justify-between">
                ...
                <div>
                    <h1 class="text-4xl md:text-5xl font-normal mb-4">Torta de Graduación Dorada con Base Decorativa</h1>
 ...
 <!-- MINIATURAS (8 COMPLETAS) -->
    <div class="mt-16">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-6">
            ...
            <img src="./assets/img/banquete/torta/grado/06_torta/01_dorada.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/06_torta/02_dorada.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/06_torta/03_dorada.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/06_torta/04_dorada.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/06_torta/05_dorada.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/06_torta/06_dorada.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/06_torta/07_dorada.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/torta/grado/06_torta/08_dorada.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">
        </div>
    </div>
