        ...
        <div class="producto" data-genero="femenino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                <img src="./assets/img/eventos/cumple/vestuarios/vestidos/vestido_corto.webp"
                     class="w-full h-[420px] object-cover">
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-semibold mb-3">Vestido Brillante Fiesta</h3>
        ...
        <div class="producto" data-genero="femenino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                <img src="./assets/img/eventos/cumple/vestuarios/vestidos/vestido_coctel.webp"
                     class="w-full h-[420px] object-cover">
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-semibold mb-3">Vestido Corto Glam</h3>
                    <p class="text-2xl font-bold mb-6">$419.990</p>
        ...
        <div class="producto" data-genero="femenino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                <img src="./assets/img/eventos/cumple/vestuarios/vestidos/vestido_largo.webp"
                     class="w-full h-[420px] object-cover">
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-semibold mb-3">Vestido Elegante Satinado</h3>
                    <p class="text-2xl font-bold mb-6">$479.990</p>
                    <a href="<?= BASE_URL ?>/detallesvestuarios/cumple/vestido/largo" class="inline-block bg-orange-500 text-white px-6 py-3 rounded-xl hover:bg-orange-600 transition">
                        Ver más
                    </a>
                </div>
            </div>
        ...
        <div class="producto" data-genero="femenino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                <img src="./assets/img/eventos/cumple/vestuarios/vestidos/vestido_capas.webp"
                     class="w-full h-[420px] object-cover">
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-semibold mb-3">Vestido Manga Larga Chic</h3>
...
<div class="producto hidden" data-genero="nino">
    <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
        ...
        <div class="p-8 text-center">
            ...
            <a href="<?= BASE_URL ?>/detallesvestuarios/cumple/nino/caballero" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition">
                Ver más
            </a>
        </div>
    </div>
...
<div class="producto hidden" data-genero="nino">
    <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
        ...
        <div class="p-8 text-center">
            ...
            <a href="<?= BASE_URL ?>/detallesvestuarios/cumple/nino/aventurqa" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition">
                Ver más
            </a>
        </div>
    </div>
