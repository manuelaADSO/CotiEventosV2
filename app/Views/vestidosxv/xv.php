<!-- ===== HERO ===== -->
<div class="pt-20">
    <section class="bg-gradient-to-r from-pink-500 via-pink-300 to-pink-400 py-24">
        ...
        <div class="producto hidden" data-genero="nino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                ...
                <div class="p-8 text-center">
                    ...
                    <a href="<?= BASE_URL ?>/detallesvestuarios/xv/nino/caballero" class="inline-block bg-green-300 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition">Ver más</a>
                </div>
            </div>
        </div>
        ...
        <div class="producto hidden" data-genero="nino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                ...
                <div class="p-8 text-center">
                    ...
                    <a href="<?= BASE_URL ?>/detallesvestuarios/xv/nino/moderno" class="inline-block bg-green-300 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition">Ver más</a>
                </div>
            </div>
        </div>
        ...
        <div class="producto hidden" data-genero="nino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                ...
                <div class="p-8 text-center">
                    ...
                    <p class="text-2xl font-bold mb-6">$329.990</p>
                    <a href="<?= BASE_URL ?>/detallesvestuarios/xv/nino/semiformal" class="inline-block bg-green-300 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition">Ver más</a>
                </div>
            </div>
        </div>
        ...
        <div class="producto hidden" data-genero="nino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                ...
                <div class="p-8 text-center">
                    ...
                    <p class="text-2xl font-bold mb-6">$359.990</p>
                    <a href="<?= BASE_URL ?>/detallesvestuarios/xv/nino/divertido" class="inline-block bg-green-300 bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition">Ver más</a>
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ocultar todos excepto femenino al inicio
    productos.forEach(producto => {
        if (producto.dataset.genero !== 'femenino') {
