...
<title>Pollo en salsa cremosa con papas fritas</title>
...
src="/cotieventosV2/assets/img/banquete/menu/inicio/pollo_salsa.webp"
class="w-full h-full object-contain transition duration-700"
alt="Pollo en salsa cremosa con papas fritas">
</div>
...
<img src="/cotieventosV2/assets/img/banquete/menu/03_menu/01_papas.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/03_menu/02_papas.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/03_menu/03_papas.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/03_menu/04_papas.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/03_menu/05_papas.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/03_menu/06_papas.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/03_menu/07_papas.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/03_menu/08_papas.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>
