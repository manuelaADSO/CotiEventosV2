...
<title>Pollo Asado con Papas Doradas</title>
...
src="/cotieventosV2/assets/img/banquete/menu/inicio/pollo_papas.webp"
class="w-full h-full object-contain transition duration-700"
alt="Pollo asado con papas doradas">
</div>
...
<img src="/cotieventosV2/assets/img/banquete/menu/01_menu/01_pollo.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/01_menu/02_pollo.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/01_menu/03_pollo.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/01_menu/04_pollo.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/01_menu/05_pollo.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/01_menu/06_pollo.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/01_menu/07_pollo.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>

<div class="swiper-slide">
<img src="/cotieventosV2/assets/img/banquete/menu/01_menu/08_pollo.webp"
class="rounded-3xl h-[300px] w-full object-cover cursor-pointer">
</div>
