...
<head>
    ...
    <title>Pollo en salsa cremosa</title>
...
<body class="bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 py-10">
        ...
        <div class="grid md:grid-cols-2 gap-12">
            ...
            <div>
                <img id="imagen-principal"
                     src="./assets/img/banquete/menu/pollo_salsa.webp" 
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-16">
            <img src="./assets/img/banquete/menu/03_menu/01_papas.webp" 
                 class="w-full h-[250px] object-cover rounded-2xl cursor-pointer hover:scale-105 transition" 
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/menu/03_menu/02_papas.webp" 
                 class="w-full h-[250px] object-cover rounded-2xl cursor-pointer hover:scale-105 transition" 
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/menu/03_menu/03_papas.webp" 
                 class="w-full h-[250px] object-cover rounded-2xl cursor-pointer hover:scale-105 transition" 
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/menu/03_menu/04_papas.webp" 
                 class="w-full h-[250px] object-cover rounded-2xl cursor-pointer hover:scale-105 transition" 
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/menu/03_menu/05_papas.webpg" 
                 class="w-full h-[250px] object-cover rounded-2xl cursor-pointer hover:scale-105 transition" 
                 onclick="cambiarImagen(this)">

            <img src="../assets/img/banquete/menu/03_menu/06_papas.webp" 
                 class="w-full h-[250px] object-cover rounded-2xl cursor-pointer hover:scale-105 transition" 
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/menu/03_menu/07_papas.webp" 
                 class="w-full h-[250px] object-cover rounded-2xl cursor-pointer hover:scale-105 transition" 
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/menu/03_menu/08_papas.webp" 
                 class="w-full h-[250px] object-cover rounded-2xl cursor-pointer hover:scale-105 transition" 
                 onclick="cambiarImagen(this)">
        </div>
