        ...
        <section class="bg-gradient-to-r from-cyan-400 via-cyan-200 to-cyan-300 py-20">
            <div class="max-w-6xl mx-auto text-center px-6">
                <h1 class="text-4xl md:text-5xl font-bold mb-4 text-olive animate-fadeIn">
                    Paquete Premium - Bautizo
                </h1>
                <p class="text-lg text-olive/90 animate-fadeIn delay-200">
                    Cobertura completa del Bautizo, registrando cada detalle especial y emotivo.
                </p>
            </div>
        </section>
    </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="flex justify-center order-1 md:order-2 animate-fadeIn delay-200">
                <img src="/cotieventosV2/assets/img/fotografia/paquetes/bautizo/premium/invitados.webp"
            ...
            <div class="order-2 md:order-1">
                ...
                <p class="text-gray-600 mb-4 animate-fadeIn delay-400">
                    Cobertura completa del Bautizo con fotógrafo adicional, fotos de todos los detalles y momentos especiales.
                </p>
                <ul class="list-none space-y-3 text-gray-600">
                    <li class="flex items-center gap-3 animate-fadeIn delay-500"><span class="text-cyan-600 text-xl">⛪</span> Cobertura de la ceremonia religiosa</li>
                    <li class="flex items-center gap-3 animate-fadeIn delay-600"><span class="text-cyan-600 text-xl">📸</span> Fotos de la familia y padrinos</li>
                    <li class="flex items-center gap-3 animate-fadeIn delay-700"><span class="text-cyan-600 text-xl">🎉</span> Captura de la celebración y decoración</li>
                    <li class="flex items-center gap-3 animate-fadeIn delay-800"><span class="text-cyan-600 text-xl">💾</span> Fotos digitales en alta resolución</li>
                    <li class="flex items-center gap-3 animate-fadeIn delay-900"><span class="text-cyan-600 text-xl">📸</span> Fotógrafo adicional para más ángulos</li>
                </ul>
            </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <img src="/cotieventosV2/assets/img/fotografia/paquetes/bautizo/premium/ceremonia.webp" 
                class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-400">
                <img src="/cotieventosV2/assets/img/fotografia/paquetes/bautizo/premium/padrinos.webp" 
    ...
    <section class="py-12 bg-white">
        <div class="max-w-6xl mx-auto px-6 text-center flex flex-col md:flex-row justify-center gap-4">
            <a href="<?= BASE_URL ?>/fotografia/bautizo"
               class="inline-block bg-cyan-300 text-olive font-semibold px-8 py-3 rounded-full shadow-lg hover:bg-cyan-400 transition animate-fadeIn delay-600">
               Volver a Paquetes de Bautizo
            </a>
            <a href="<?= BASE_URL ?>/carrito"
               class="inline-block bg-cyan-400 text-olive font-semibold px-8 py-3 rounded-full shadow-lg hover:bg-cyan-300 transition animate-fadeIn delay-700">
               Reserva tu Paquete
            </a>
        </div>
    </section>
