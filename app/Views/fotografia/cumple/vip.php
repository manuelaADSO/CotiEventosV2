        ...
        <section class="bg-gradient-to-r from-pink-400 via-pink-200 to-pink-300 py-20">
            <div class="max-w-6xl mx-auto text-center px-6">
                <h1 class="text-4xl md:text-5xl font-bold mb-4 text-olive animate-fadeIn">
                    Paquete VIP - Cumpleaños
                </h1>
                <p class="text-lg text-olive/90 animate-fadeIn delay-200">
                    Experiencia completa para capturar cada detalle, emoción y diversión de tu fiesta.
                </p>
            </div>
        </section>
    </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="flex justify-center order-1 md:order-2 opacity-0 animate-fadeIn">
                <img src="/cotieventosV2/assets/img/fotografia/paquetes/cumple/vip/individual.webp"
            ...
            <div class="order-2 md:order-1 opacity-0 animate-fadeIn delay-200">
                ...
                <p class="text-gray-600 mb-4">
                    Cobertura total y personalizada de tu fiesta de cumpleaños, incluyendo todos los momentos divertidos y detalles especiales.
                </p>

                <ul class="list-none space-y-3 text-gray-600">
                    <li class="flex items-center gap-3"><span class="text-pink-600 text-xl">🎂</span> Cobertura completa de pastel, juegos y brindis</li>
                    <li class="flex items-center gap-3"><span class="text-pink-600 text-xl">📸</span> Fotos profesionales y espontáneas de invitados</li>
                    <li class="flex items-center gap-3"><span class="text-pink-600 text-xl">🎈</span> Detalles de decoración y ambientación capturados en fotos</li>
                    <li class="flex items-center gap-3"><span class="text-pink-600 text-xl">🎬</span> Video corto con los mejores momentos de la fiesta</li>
                    <li class="flex items-center gap-3"><span class="text-pink-600 text-xl">💾</span> Todas las fotos digitales en alta resolución</li>
                    <li class="flex items-center gap-3"><span class="text-pink-600 text-xl">🌟</span> Galería privada en línea + álbum digital personalizado</li>
                    <li class="flex items-center gap-3"><span class="text-pink-600 text-xl">✨</span> Sesión temática opcional antes o durante la fiesta</li>
                </ul>
            </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <img src="/cotieventosV2/assets/img/fotografia/paquetes/cumple/vip/solo.webp"
                 class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition">
                <img src="/cotieventosV2/assets/img/fotografia/paquetes/cumple/vip/persona.webp"
                 class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition">
            </div>
