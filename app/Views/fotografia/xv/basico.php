        ...
        <section class="bg-gradient-to-r from-fuchsia-400 via-fuchsia-200 to-fuchsia-300 py-20">
            <div class="max-w-6xl mx-auto text-center px-6">
                <h1 class="text-4xl md:text-5xl font-bold mb-4 text-olive animate-fadeIn">
                    Paquete Básico - XV Años
                </h1>
                <p class="text-lg text-olive/90 animate-fadeIn delay-200">
                    Cobertura de los momentos esenciales para que tu noche sea inolvidable.
                </p>
            </div>
        </section>
    </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="flex justify-center order-1 md:order-2 opacity-0 animate-fadeIn">
                <img src="./assets/img/fotografia/xv_basico.jpg"
            ...
            <div class="order-2 md:order-1 opacity-0 animate-fadeIn delay-200">
                ...
                <p class="text-gray-600 mb-4">
                    Cobertura de los momentos más importantes de tu fiesta de XV años, capturando recuerdos naturales y emocionantes.
                </p>

                <ul class="list-none space-y-3 text-gray-600">
                    <li class="flex items-center gap-3"><span class="text-fuchsia-600 text-xl">👑</span> Cobertura de ceremonia y entrada</li>
                    <li class="flex items-center gap-3"><span class="text-fuchsia-600 text-xl">🎉</span> Fotos espontáneas de invitados y baile</li>
                    <li class="flex items-center gap-3"><span class="text-fuchsia-600 text-xl">📸</span> Retratos de la quinceañera con familiares y amigos</li>
                    <li class="flex items-center gap-3"><span class="text-fuchsia-600 text-xl">💾</span> Entrega digital de todas las fotos en alta resolución</li>
                </ul>
            </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <img src="./assets/img/fotografia/xv1.jpg" class="rounded-xl shadow-lg hover:scale-105 transition">
                <img src="./assets/img/fotografia/xv2.jpg" class="rounded-xl shadow-lg hover:scale-105 transition">
                <img src="./assets/img/fotografia/xv3.jpg" class="rounded-xl shadow-lg hover:scale-105 transition">
            </div>
        </div>
    </section>
