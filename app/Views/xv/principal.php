<div class="pt-20">
  <section class="h-[70vh] flex flex-col md:flex-row overflow-hidden relative">
    ...
    <div class="md:w-1/2 w-full flex flex-col justify-center items-center bg-gradient-to-br from-purple-400 via-purple-200 to-purple-300 p-12 text-center relative z-10"
         style="margin-left: -5%; clip-path: polygon(15% 0, 100% 0, 100% 100%, 0% 100%);">
      
      <div class="z-10">
        <h1 class="text-5xl md:text-7xl font-black text-olive-900 mb-2 uppercase tracking-tighter">
          XV Años
        </h1>
        <div class="h-1 w-20 bg-gray-800 mx-auto mb-6"></div>
        <h2 class="text-2xl md:text-3xl font-light text-olive-700 italic mb-6">
          Celebración Inolvidable
        </h2>
        <p class="max-w-md text-lg text-olive-800 leading-relaxed">
    ...
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="order-2 md:order-1">
            ...
            <p class="text-gray-600 mb-4">
                Tus XV años merecen mucho más que una fiesta: merecen convertirse
                en un recuerdo mágico que marque el inicio de una nueva historia.
            </p>
            <p class="text-gray-600 mb-4">
                Creamos una atmósfera soñada donde cada detalle resalta la belleza,
                la ilusión y la alegría de este momento único.
            </p>
            <p class="text-gray-600 mb-4">
                Vive una celebración elegante, brillante y completamente personalizada.
            </p>
        </div>
                ...
                <div class="flex items-start gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">
                            Elegantes vestidos y trajes para que la quinceañera
                            y sus acompañantes brillen con estilo.
                        </p>
                    </div>
                </div>
            </a>
               ...
               class="relative block bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition duration-300 group overflow-hidden">
                ...
                <div class="flex items-start gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">
                            Menús especiales y dulces elegantes para celebrar
                            este día tan esperado.
                        </p>
                    </div>
                </div>
            </a>
               ...
               class="relative block bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition duration-300 group overflow-hidden">
                ...
                <div class="flex items-start gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">
                            DJ, coreografías y ambientación perfecta para
                            una noche llena de emoción y diversión.
                        </p>
                    </div>
                </div>
            </a>
               ...
               class="relative block bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition duration-300 group overflow-hidden">
                ...
                <div class="flex items-start gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">
                            Capturamos cada emoción para que este día
                            mágico quede guardado para siempre.
                        </p>
                    </div>
                </div>
            </a>
