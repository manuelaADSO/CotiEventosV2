...
<!-- ===== HERO ===== -->
<div class="pt-20">
    <section class="bg-gradient-to-r from-green-500 via-green-300 to-green-400 py-24">
...
<div class="max-w-7xl mx-auto px-6 py-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-12" id="productos-grid">
        ...
        <!-- ================= NIÑO ================= -->
        <div class="producto" data-genero="nino">
...
selectGenero.addEventListener('change', () => {
    ...
    productos.forEach(prod => {
        if(prod.dataset.genero === generoSeleccionado){
