...
<div class="pt-20">
    <section class="bg-gradient-to-r from-sky-400 via-sky-200 to-sky-300 py-24">
        <div class="max-w-6xl mx-auto text-center px-6">
            ...
            <div class="w-24 h-1 bg-sky-500 mx-auto mb-6 rounded-full"></div>
        ...
        <div class="producto" data-genero="masculino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                ...
                <div class="p-8 text-center">
                    ...
                    <a href="<?= BASE_URL ?>/detallesvestuarios/cumple/trajes/contemporaneo" class="inline-block bg-gray-900 text-white px-6 py-3 rounded-xl hover:bg-gray-700 transition">
                        Ver más
                    </a>
                </div>
            </div>
...
<div class="producto hidden" data-genero="nino">
    <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
        ...
        <div class="p-8 text-center">
            ...
            <a href="<?= BASE_URL ?>/detallesvestuarios/cumple/nino/principa" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition">
                Ver más
            </a>
        </div>
    </div>
