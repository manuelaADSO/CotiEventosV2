    ...
    <section class="bg-gradient-to-r from-emerald-400 via-emerald-200 to-emerald-300 py-20">
        <div class="max-w-6xl mx-auto text-center px-6">
            ...
            <p class="text-lg text-olive/90 animate-fadeIn delay-200">
                El máximo espectáculo musical en vivo, con atención exclusiva y experiencia inolvidable.
            </p>
        </div>
    </section>
</div>
...
<section class="py-16 bg-white">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex justify-center order-1 md:order-2 animate-fadeIn delay-200">
            <img src="/cotieventosV2/assets/img/musica/banda/inicio/05_banda.webp"
                 class="w-full max-w-md h-80 object-cover rounded-2xl shadow-2xl border-4 border-emerald-500">
        </div>

        <div class="order-2 md:order-1 animate-fadeIn delay-400">
            <h2 class="text-3xl font-bold text-center text-olive-700 mb-4">
                Qué incluye este paquete
            </h2>

            <p class="text-gray-600 mb-4">
                El Paquete VIP está pensado para quienes buscan una experiencia musical de lujo, con banda completa, luces, sonido premium y atención personalizada.
            </p>

            <ul class="list-none space-y-3 text-gray-600">

                <li class="flex items-center gap-3 animate-fadeIn delay-500">
                    <span class="text-emerald-700 text-xl">🎤</span> Banda en vivo con 8 a 10 músicos
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-600">
                    <span class="text-emerald-700 text-xl">🎶</span> Repertorio completo: pop, salsa, tropical, música actual y clásicos
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-700">
                    <span class="text-emerald-700 text-xl">🔊</span> Sonido profesional de alta gama con luces LED y efectos especiales
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-800">
                    <span class="text-emerald-700 text-xl">💃</span> Animación, interacción, coreografías y show personalizado
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-900">
                    <span class="text-emerald-700 text-xl">⏱</span> 5 horas de presentación musical
                </li>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6">
        <h2 class="text-3xl font-bold text-center text-olive-700 mb-8 animate-fadeIn delay-200">
            Galería del Paquete
        </h2>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <img src="/cotieventosV2/assets/img/musica/banda/paquetes/vip/banda.webp" 
            class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-300">
            <img src="/cotieventosV2/assets/img/musica/banda/paquetes/vip/sonido.webp"
             class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-400">
            <img src="/cotieventosV2/assets/img/musica/banda/paquetes/vip/musical.webp" 
