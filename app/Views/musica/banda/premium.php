    ...
    <section class="bg-gradient-to-r from-teal-400 via-teal-200 to-teal-300 py-20">
        <div class="max-w-6xl mx-auto text-center px-6">
            ...
            <p class="text-lg text-olive/90 animate-fadeIn delay-200">
                Una experiencia musical única con banda en vivo, sonido profesional y espectáculo completo.
            </p>
        </div>
    </section>
</div>
...
<section class="py-16 bg-white">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex justify-center order-1 md:order-2 animate-fadeIn delay-200">
            <img src="/cotieventosV2/assets/img/musica/banda/inicio/04_banda.webp"
                 class="w-full max-w-md h-80 object-cover rounded-2xl shadow-2xl border-4 border-teal-400">
        </div>
        ...
        <div class="order-2 md:order-1 animate-fadeIn delay-400">
            ...
            <p class="text-gray-600 mb-4">
                El Paquete Premium está diseñado para quienes quieren un espectáculo musical completo, con la mejor calidad y atención personalizada.
            </p>

            <ul class="list-none space-y-3 text-gray-600">

                <li class="flex items-center gap-3 animate-fadeIn delay-500">
                    <span class="text-teal-600 text-xl">🎤</span> Banda en vivo con 7 a 8 músicos
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-600">
                    <span class="text-teal-600 text-xl">🎶</span> Repertorio variado: pop, salsa, tropical y éxitos actuales
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-700">
                    <span class="text-teal-600 text-xl">🔊</span> Sonido profesional premium y luces para espectáculo
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-800">
                    <span class="text-teal-600 text-xl">💃</span> Animación, interacción y coreografías con los invitados
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-900">
                    <span class="text-teal-600 text-xl">⏱</span> 4 horas de presentación musical
                </li>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <img src="/cotieventosV2/assets/img/musica/banda/paquetes/premium/banda.webp" 
            class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-300">
            <img src="/cotieventosV2/assets/img/musica/banda/paquetes/premium/sonido.webp" 
            class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-400">
            <img src="/cotieventosV2/assets/img/musica/banda/paquetes/premium/musical.webp"
