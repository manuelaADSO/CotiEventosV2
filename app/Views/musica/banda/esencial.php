    ...
    <section class="bg-gradient-to-r from-indigo-400 via-indigo-200 to-indigo-300 py-20">
        <div class="max-w-6xl mx-auto text-center px-6">
            ...
            <p class="text-lg text-olive/90 animate-fadeIn delay-200">
                Música en vivo para crear un ambiente alegre y auténtico en tu evento.
            </p>
        </div>
    </section>
</div>
...
<section class="py-16 bg-white">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex justify-center order-1 md:order-2 animate-fadeIn delay-200">
            <img src="/cotieventosV2/assets/img/musica/banda/inicio/01_banda.webp"
        ...
        <div class="order-2 md:order-1 animate-fadeIn delay-400">
            ...
            <p class="text-gray-600 mb-4">
                El paquete Banda Esencial es perfecto para celebraciones pequeñas
                que desean disfrutar de la energía de la música en vivo.
            </p>

            <ul class="list-none space-y-3 text-gray-600">

                <li class="flex items-center gap-3 animate-fadeIn delay-500">
                    <span class="text-indigo-600 text-xl">🎤</span> Banda en vivo con 4 músicos
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-600">
                    <span class="text-indigo-600 text-xl">🎶</span> Repertorio tropical y popular
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-700">
                    <span class="text-indigo-600 text-xl">🔊</span> Sistema de sonido básico
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-800">
                    <span class="text-indigo-600 text-xl">💃</span> Animación musical para el público
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-900">
                    <span class="text-indigo-600 text-xl">⏱</span> 2 horas de presentación
                </li>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <img src="/cotieventosV2/assets/img/musica/banda/paquetes/esencial/banda.webp" 
            class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-300">
            <img src="/cotieventosV2/assets/img/musica/banda/paquetes/esencial/sonido.webp" 
            class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-400">
            <img src="/cotieventosV2/assets/img/musica/banda/paquetes/esencial/musical.webp"
...
<section class="py-12 bg-white">
    <div class="max-w-6xl mx-auto px-6 text-center flex flex-col md:flex-row justify-center gap-4">
        ...
        <a href="<?= BASE_URL ?>/musica/banda"
           class="inline-block bg-indigo-300 text-olive font-semibold px-8 py-3 rounded-full shadow-lg hover:bg-indigo-400 transition animate-fadeIn delay-600">
           Volver a Paquetes de Banda
        </a>

        <a href="<?= BASE_URL ?>/carrito"
           class="inline-block bg-indigo-400 text-olive font-semibold px-8 py-3 rounded-full shadow-lg hover:bg-indigo-300 transition animate-fadeIn delay-700">
           Reserva tu Banda
        </a>
