    ...
    <section class="bg-gradient-to-r from-sky-400 via-sky-200 to-sky-300 py-20">
        <div class="max-w-6xl mx-auto text-center px-6">
            ...
            <p class="text-lg text-olive/90 animate-fadeIn delay-200">
                Más músicos, más ritmo y un espectáculo musical para animar tu celebración.
            </p>
        </div>
    </section>
</div>
...
<section class="py-16 bg-white">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex justify-center order-1 md:order-2 animate-fadeIn delay-200">
            <img src="/cotieventosV2/assets/img/musica/banda/inicio/02_banda.webp"
                 class="w-full max-w-md h-80 object-cover rounded-2xl shadow-2xl border-4 border-sky-300">
        </div>
        ...
        <div class="order-2 md:order-1 animate-fadeIn delay-400">
            ...
            <p class="text-gray-600 mb-4">
                El paquete Banda Fiesta es ideal para eventos donde se quiere
                un ambiente lleno de energía, baile y música en vivo durante
            ...
            <ul class="list-none space-y-3 text-gray-600">
                ...
                <li class="flex items-center gap-3 animate-fadeIn delay-500">
                    <span class="text-sky-600 text-xl">🎤</span> Banda en vivo con 6 músicos
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-600">
                    <span class="text-sky-600 text-xl">🎶</span> Repertorio tropical, salsa y popular
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-700">
                    <span class="text-sky-600 text-xl">🔊</span> Sistema de sonido profesional
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-800">
                    <span class="text-sky-600 text-xl">💃</span> Interacción y animación con los invitados
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-900">
                    <span class="text-sky-600 text-xl">⏱</span> 3 horas de presentación musical
                </li>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <img src="/cotieventosV2/assets/img/musica/banda/paquetes/fiesta/banda.webp" 
            class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-300">
            <img src="/cotieventosV2/assets/img/musica/banda/paquetes/fiesta/sonido.webp" 
            class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-400">
            <img src="/cotieventosV2/assets/img/musica/banda/paquetes/fiesta/musical.webp" 
