    ...
    <section class="bg-gradient-to-r from-pink-400 via-pink-200 to-pink-300 py-20">
        <div class="max-w-6xl mx-auto text-center px-6">
            ...
            <p class="text-lg text-olive/90 animate-fadeIn delay-200">
                Todos los efectos a máxima potencia: luces, humo, confeti y pirotecnia para un evento inolvidable.
            </p>
        </div>
    </section>
</div>
...
<section class="py-16 bg-white">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex justify-center order-1 md:order-2 animate-fadeIn delay-200">
            <img src="/cotieventosV2/assets/img/musica/efectos/inicio/05_efecto.webp"
        ...
        <div class="order-2 md:order-1 animate-fadeIn delay-400">
            ...
            <p class="text-gray-600 mb-4">
                El paquete VIP combina todos nuestros efectos especiales en máxima intensidad para crear un espectáculo inolvidable durante todo el evento.
            </p>

            <ul class="list-none space-y-3 text-gray-600">
                <li class="flex items-center gap-3 animate-fadeIn delay-500">
                    <span class="text-pink-600 text-xl">💡</span> Iluminación profesional completa con movimientos y efectos especiales
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-600">
                    <span class="text-pink-600 text-xl">🎉</span> Confeti, burbujas y cañones en todos los momentos importantes
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-700">
                    <span class="text-pink-600 text-xl">💨</span> Humo y niebla de alta densidad para efectos espectaculares
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-800">
                    <span class="text-pink-600 text-xl">🎆</span> Pirotecnia de impacto y efectos visuales avanzados
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-900">
                    <span class="text-pink-600 text-xl">🔊</span> Coordinación total con DJ y animación del evento
                </li>
            </ul>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <img src="/cotieventosV2/assets/img/musica/efectos/paquetes/vip/confeti.webp" 
            class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-300">
            <img src="/cotieventosV2/assets/img/musica/efectos/paquetes/vip/humo.webp" 
            class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-400">
            <img src="/cotieventosV2/assets/img/musica/efectos/paquetes/vip/cañones.webp" 
