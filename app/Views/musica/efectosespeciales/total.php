    ...
    <section class="bg-gradient-to-r from-fuchsia-400 via-fuchsia-200 to-fuchsia-300 py-20">
        <div class="max-w-6xl mx-auto text-center px-6">
            <h1 class="text-4xl md:text-5xl font-bold mb-4 text-olive animate-fadeIn">
                Paquete Efectos Espectáculo Total
            </h1>
            <p class="text-lg text-olive/90 animate-fadeIn delay-200">
                El paquete más completo para un evento espectacular: luces, humo, confeti, pirotecnia y efectos especiales al máximo.
            </p>
        </div>
    </section>
</div>
...
<section class="py-16 bg-white">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex justify-center order-1 md:order-2 animate-fadeIn delay-200">
            <img src="/cotieventosV2/assets/img/musica/efectos/inicio/06_efecto.webp"
        ...
        <div class="order-2 md:order-1 animate-fadeIn delay-400">
            ...
            <p class="text-gray-600 mb-4">
                El paquete Espectáculo Total ofrece todos los efectos especiales posibles, con máxima intensidad y coordinación para hacer de tu evento algo inolvidable.
            </p>

            <ul class="list-none space-y-3 text-gray-600">
                <li class="flex items-center gap-3 animate-fadeIn delay-500">
                    <span class="text-fuchsia-600 text-xl">💡</span> Iluminación profesional completa con movimientos, colores y efectos especiales
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-600">
                    <span class="text-fuchsia-600 text-xl">🎉</span> Confeti, burbujas y cañones en todos los momentos destacados
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-700">
                    <span class="text-fuchsia-600 text-xl">💨</span> Humo y niebla profesional para crear ambientes espectaculares
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-800">
                    <span class="text-fuchsia-600 text-xl">🎆</span> Pirotecnia y efectos visuales de gran impacto
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-900">
                    <span class="text-fuchsia-600 text-xl">🔊</span> Coordinación total con DJ, música y animación
                </li>
            </ul>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <img src="/cotieventosV2/assets/img/musica/efectos/paquetes/total/cañones.webp" 
            class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-300">
            <img src="/cotieventosV2/assets/img/musica/efectos/paquetes/total/burbujas.webp" 
            class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-400">
            <img src="/cotieventosV2/assets/img/musica/efectos/paquetes/total/confeti.webp" 
