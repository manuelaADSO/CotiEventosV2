    ...
    <section class="bg-gradient-to-r from-violet-400 via-violet-200 to-violet-300 py-20">
        <div class="max-w-6xl mx-auto text-center px-6">
            ...
            <p class="text-lg text-olive/90 animate-fadeIn delay-200">
                Música profesional y ambiente perfecto para animar cualquier celebración.
            </p>
        </div>
    </section>
</div>
...
<section class="py-16 bg-white">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex justify-center order-1 md:order-2 animate-fadeIn delay-200">
            <img src="/cotieventosV2/assets/img/musica/dj/inicio/01_dj.webp"
                 class="w-full max-w-md h-80 object-cover rounded-2xl shadow-2xl border-4 border-purple-300">
        </div>
        ...
        <div class="order-2 md:order-1 animate-fadeIn delay-400">
            ...
            <p class="text-gray-600 mb-4">
                Nuestro paquete básico incluye todo lo necesario para crear un ambiente
                musical agradable y animado durante tu evento.
            </p>

            <ul class="list-none space-y-3 text-gray-600">
                <li class="flex items-center gap-3 animate-fadeIn delay-500">
                    <span class="text-violet-600 text-xl">🎧</span> DJ profesional durante el evento
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-600">
                    <span class="text-violet-600 text-xl">🔊</span> Equipo de sonido básico
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-700">
                    <span class="text-violet-600 text-xl">💡</span> Iluminación básica para pista de baile
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-800">
                    <span class="text-violet-600 text-xl">🎶</span> Música variada según el tipo de evento
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-900">
                    <span class="text-violet-600 text-xl">🎤</span> Micrófono inalámbrico para animación
                </li>
            </ul>
...
<section class="py-16 bg-gray-50">
    ...
    <img src="/cotieventosV2/assets/img/musica/dj/paquetes/basico/dj.webp" 
         class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-300">

    <img src="/cotieventosV2/assets/img/musica/dj/paquetes/basico/luz_pista.webp" 
         class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-400">

    <img src="/cotieventosV2/assets/img/musica/dj/paquetes/basico/sonido.webp" 
...
<section class="py-12 bg-white">
    <div class="max-w-6xl mx-auto px-6 text-center flex flex-col md:flex-row justify-center gap-4">
        ...
        <a href="<?= BASE_URL ?>/musica/dj"
           class="inline-block bg-violet-400 text-olive font-semibold px-8 py-3 rounded-full shadow-lg hover:bg-violet-300 transition animate-fadeIn delay-600">
           Volver a Paquetes de DJ
        </a>

        <a href="<?= BASE_URL ?>/carrito"
           class="inline-block bg-violet-300 text-olive font-semibold px-8 py-3 rounded-full shadow-lg hover:bg-violet-400 transition animate-fadeIn delay-700">
           Reserva tu Paquete
        </a>
