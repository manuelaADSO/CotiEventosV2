    ...
    <section class="bg-gradient-to-r from-indigo-400 via-indigo-200 to-indigo-300 py-20">
        <div class="max-w-6xl mx-auto text-center px-6">
            <h1 class="text-4xl md:text-5xl font-bold mb-4 text-olive animate-fadeIn">
                Paquete DJ Full Evento
            </h1>
            <p class="text-lg text-olive/90 animate-fadeIn delay-200">
                El paquete más completo para eventos inolvidables con producción profesional, efectos especiales y animación total.
            </p>
        </div>
    </section>
</div>
...
<section class="py-16 bg-white">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex justify-center order-1 md:order-2 animate-fadeIn delay-200">
            <img src="/cotieventosV2/assets/img/musica/dj/inicio/06_dj.webp"
                 class="w-full max-w-md h-80 object-cover rounded-2xl shadow-2xl border-4 border-indigo-300">
        </div>
        ...
        <div class="order-2 md:order-1 animate-fadeIn delay-400">
            ...
            <p class="text-gray-600 mb-4">
                El paquete Full Evento ofrece una experiencia completa de música,
                iluminación profesional, efectos especiales y animación para que
                tu celebración sea única e inolvidable.
            </p>
            ...
            <ul class="list-none space-y-3 text-gray-600">
                ...
                <li class="flex items-center gap-3 animate-fadeIn delay-500">
                    ...
                    DJ profesional durante todo el evento
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-600">
                    <span class="text-indigo-600 text-xl">🔊</span>
                    Sistema de sonido profesional de alta potencia
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-700">
                    <span class="text-indigo-600 text-xl">💡</span>
                    Iluminación inteligente para pista de baile
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-800">
                    <span class="text-indigo-600 text-xl">✨</span>
                    Chispas frías para momentos especiales
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-900">
                    <span class="text-indigo-600 text-xl">🌫</span>
                    Efecto de humo bajo para entradas o baile principal
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-1000">
                    <span class="text-indigo-600 text-xl">🎤</span>
                    Micrófonos inalámbricos para animación
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-1100">
                    <span class="text-indigo-600 text-xl">🕺</span>
                    Animación musical y ambiente festivo
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-1200">
                    <span class="text-indigo-600 text-xl">🎶</span>
                    Playlist personalizada según el tipo de evento
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-1300">
                    <span class="text-indigo-600 text-xl">🎆</span>
                    Producción completa de efectos y ambientación
                </li>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <img src="/cotieventosV2/assets/img/musica/dj/paquetes/fullevento/dj.webp"
            class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-300">

            <img src="/cotieventosV2/assets/img/musica/dj/paquetes/fullevento/efectos.webp"
                 class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-400">

            <img src="/cotieventosV2/assets/img/musica/dj/paquetes/fullevento/luz_pista.webp"
