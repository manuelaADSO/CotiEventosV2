    ...
    <section class="bg-gradient-to-r from-fuchsia-400 via-fuchsia-200 to-fuchsia-300 py-20">
        <div class="max-w-6xl mx-auto text-center px-6">
            ...
            <p class="text-lg text-olive/90 animate-fadeIn delay-200">
                Una experiencia musical completa con iluminación profesional y efectos especiales.
            </p>
        </div>
    </section>
</div>
...
<section class="py-16 bg-white">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex justify-center order-1 md:order-2 animate-fadeIn delay-200">
            <img src="/cotieventosV2/assets/img/musica/dj/inicio/03_dj.webp"
                 class="w-full max-w-md h-80 object-cover rounded-2xl shadow-2xl border-4 border-fuchsia-300">
        </div>
        ...
        <div class="order-2 md:order-1 animate-fadeIn delay-400">
            ...
            <p class="text-gray-600 mb-4">
                El paquete Premium ofrece una experiencia más completa,
                con sonido profesional, iluminación avanzada y efectos
                que transforman tu evento en una verdadera fiesta.
            </p>

            <ul class="list-none space-y-3 text-gray-600">

                <li class="flex items-center gap-3 animate-fadeIn delay-500">
                    <span class="text-fuchsia-600 text-xl">🎧</span>
                ...
                <li class="flex items-center gap-3 animate-fadeIn delay-700">
                    <span class="text-fuchsia-600 text-xl">💡</span>
                    Iluminación LED inteligente para pista de baile
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-800">
                    <span class="text-fuchsia-600 text-xl">🌫</span>
                    Efecto de humo bajo para momentos especiales
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-900">
                    <span class="text-fuchsia-600 text-xl">✨</span>
                    Luces dinámicas y ambiente festivo
                </li>

                <li class="flex items-center gap-3 animate-fadeIn delay-1000">
                    <span class="text-fuchsia-600 text-xl">🎤</span>
                    Micrófono inalámbrico para animación o presentaciones
                </li>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <img src="/cotieventosV2/assets/img/musica/dj/paquetes/premium/dj.webp"
                 class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-300">

            <img src="/cotieventosV2/assets/img/musica/dj/paquetes/premium/luces.webp"
                 class="w-full h-64 object-cover rounded-xl shadow-lg hover:scale-105 transition animate-fadeIn delay-400">

            <img src="/cotieventosV2/assets/img/musica/dj/paquetes/premium/luz_pista.webp"
