...
<div class="max-w-7xl mx-auto px-6 py-10">
    ...
    <div class="grid md:grid-cols-2 gap-12 items-start">
        ...
        <div>
            <img id="imagen-principal"
                 src="https://i.pinimg.com/1200x/1b/4b/a2/1b4ba2f3118e6e0a998ab3e3c37946ed.jpg"
    ...
    <div class="mt-20">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-6">
            ...
            <img src="./assets/img/banquete/postre/03_postre/01_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/postre/03_postre/02_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/postre/03_postre/03_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/postre/03_postre/04_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/postre/03_postre/05_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/postre/03_postre/06_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/postre/03_postre/07_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">

            <img src="./assets/img/banquete/postre/03_postre/08_corazon.webp"
                 class="w-full h-64 object-cover rounded-2xl cursor-pointer hover:scale-105 transition"
                 onclick="cambiarImagen(this)">
        </div>
    </div>
