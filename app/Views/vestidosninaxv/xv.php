<!-- ===== HERO ===== -->
<div class="pt-20">
    <section class="bg-gradient-to-r from-violet-400 via-violet-200 to-violet-300 py-24">
...
<option value="nino">Niño</option>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-12">
        ...
        <!-- ================= NIÑA ================= -->
        <div class="producto" data-genero="nina">
        ...
        <div class="producto" data-genero="femenino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                ...
                <div class="p-8 text-center">
                    ...
                    <a href="<?= BASE_URL ?>/detallesvestuarios/xv/vestido/encaje" class="inline-block bg-rose-500 text-white px-6 py-3 rounded-xl hover:bg-rose-600 transition">Ver más</a>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    productos.forEach(producto => {
        if (producto.dataset.genero !== 'nina') {
