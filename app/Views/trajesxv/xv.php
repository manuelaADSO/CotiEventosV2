...
<title>Vestidos y Trajes XV Años</title>
...
<!-- ===== HERO ===== -->
<div class="pt-20">
    <section class="bg-gradient-to-r from-blue-500 via-blue-200 to-blue-400 py-24">
        <div class="max-w-6xl mx-auto text-center px-6">
            ...
            <p class="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
                Celebra tus XV años con un look espectacular. Diseños modernos, elegantes y llenos de estilo para que seas la protagonista en tu día más especial.
            </p>
        </div>
    </section>
</div>
...
<div class="max-w-7xl mx-auto px-6 py-16">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
        <h2 class="text-3xl md:text-4xl font-semibold text-gray-800">Elige Tu Outfit Ideal</h2>
        <span class="inline-block text-4xl font-bold text-gray-800 mb-4">XV Años</span>
    </div>

    <!-- SELECT -->
    <div class="mb-14 max-w-md">
        <label class="block text-lg font-semibold mb-3 text-gray-700">Seleccionar género</label>
        <select id="genero" class="w-full border border-gray-300 rounded-xl px-5 py-4 text-lg focus:outline-none focus:ring-2 focus:ring-rose-400">
    ...
    <!-- GRID DE PRODUCTOS -->
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-12" id="productos-grid">
        ...
        <div class="producto hidden" data-genero="nino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                <img src="./assets/img/eventos/xv/vestuarios/nino/caballero.webp" class="w-full h-[420px] object-cover">
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-semibold mb-3">Pequeño Caballero</h3>
                    <p class="text-2xl font-bold mb-6">$389.990</p>
                    <a href="<?= BASE_URL ?>/detallesvestuarios/xv/nino/caballero" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition">Ver más</a>
                </div>
            </div>
        </div>
        <div class="producto hidden" data-genero="nino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                <img src="./assets/img/eventos/xv/vestuarios/nino/moderno.webp" class="w-full h-[420px] object-cover">
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-semibold mb-3">Traje Moderno</h3>
                    <p class="text-2xl font-bold mb-6">$349.990</p>
                    <a href="<?= BASE_URL ?>/detallesvestuarios/xv/nino/moderno" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition">Ver más</a>
                </div>
            </div>
        </div>
        <div class="producto hidden" data-genero="nino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                <img src="./assets/img/eventos/xv/vestuarios/nino/semiformal.webp" class="w-full h-[420px] object-cover">
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-semibold mb-3">Traje Semiformal</h3>
                    <p class="text-2xl font-bold mb-6">$369.990</p>
                    <a href="<?= BASE_URL ?>/detallesvestuarios/xv/nino/semiformal" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition">Ver más</a>
                </div>
            </div>
        </div>
        <div class="producto hidden" data-genero="nino">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                <img src="./assets/img/eventos/xv/vestuarios/nino/divertido.webp" class="w-full h-[420px] object-cover">
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-semibold mb-3">Traje Temático / Divertido</h3>
                    <p class="text-2xl font-bold mb-6">$429.990</p>
                    <a href="<?= BASE_URL ?>/detallesvestuarios/xv/nino/divertido" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition">Ver más</a>
                </div>
            </div>
        </div>

        <!-- ================= MAMA ================= -->
        <div class="producto hidden" data-genero="mama">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
        ...
        <div class="producto hidden" data-genero="nina">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                ...
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-semibold mb-3">Vestido Corto y Divertido</h3>
                    <p class="text-2xl font-bold mb-6">$349.990</p>
        ...
        <div class="producto hidden" data-genero="nina">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                <img src="./assets/img/eventos/xv/vestuarios/nina/largo.webp" class="w-full h-[420px] object-cover">
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-semibold mb-3">Vestido Largo Floral</h3>
                    <p class="text-2xl font-bold mb-6">$399.990</p>
                    <a href="<?= BASE_URL ?>/detallesvestuarios/xv/nina/largo" class="inline-block bg-purple-400 text-white px-6 py-3 rounded-xl hover:bg-pink-600 transition">Ver más</a>
                </div>
            </div>
        </div>
        <div class="producto hidden" data-genero="nina">
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                ...
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-semibold mb-3">Vestido con Brillos</h3>
                    <p class="text-2xl font-bold mb-6">$429.990</p>
...
<!-- SCRIPT FILTRO POR GÉNERO -->
<script>
document.addEventListener('DOMContentLoaded', () => {
    const generoSelect = document.getElementById('genero');
    const productos = document.querySelectorAll('.producto');

    // Mostrar solo masculino al iniciar
    productos.forEach(p => {
        p.classList.toggle('hidden', p.dataset.genero !== 'masculino');
    });

    generoSelect.addEventListener('change', function() {
        const genero = this.value;
        productos.forEach(p => {
            p.classList.toggle('hidden', p.dataset.genero !== genero);
        });
    });
});
</script>
