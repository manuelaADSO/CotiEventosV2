<!-- HERO -->
<div class="pt-20">
<section class="bg-gradient-to-r from-pink-500 via-fuchsia-500 to-yellow-400 text-white py-20">
    <div class="max-w-6xl mx-auto text-center px-6">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">
            Nuestros Servicios 🎉
        </h1>
        <p class="text-lg opacity-90">
            Creamos experiencias únicas para cada tipo de evento.
        </p>
    </div>
</section>
</div>
    ...
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300">
            ...
            <div class="p-6">
                ...
                <p class="text-gray-600 mb-4">
                    Un momento tierno y especial que convertimos en una celebración mágica e inolvidable.
                </p>
                <a href="<?= BASE_URL ?>/eventos/baby-showers" class="inline-block bg-gray-500 text-white px-6 py-2 rounded-full hover:bg-pink-600 transition">
                    Cotizar
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300">
            ...
            <div class="p-6">
                ...
                <p class="text-gray-600 mb-4">
                    Un evento lleno de fe y amor, organizado con delicadeza en cada detalle.
                </p>
                <a href="/eventos/bautizos" class="inline-block bg-green-500 text-white px-6 py-2 rounded-full hover:bg-pink-600 transition">
                    Cotizar
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300">
            ...
            <div class="p-6">
                ...
                <p class="text-gray-600 mb-4">
                    Hacemos realidad la boda de tus sueños con elegancia, romanticismo y perfección en cada instante.
                </p>
                <a href="<?= BASE_URL ?>/eventos/bodas" class="inline-block bg-pink-500 text-white px-6 py-2 rounded-full hover:bg-pink-600 transition">
                    Cotizar
                </a>
            </div>
        </div>
